# -*- coding: utf-8 -*-
"""HCNN_InceptionV3_SVM.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Q556VSOdhYSayTqBJpUM95HbeWaDHdok
...
- **Seção 3** - Implementação da CNN do tipo InceptionV3 pré-treinada com ImageNet; (**``Etapa finalizada!!``**) ✅

- **Seção 4** - Implementação da Máquina de Vetor de Suporte para classificação dos defeitos; (**``Etapa finalizada!!``**) ✅

- **Seção 5** - (**``Etapa finalizada!!``**) ✅
